...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="form" action="{{ url('/admin/templates/'. $template->id) }}" method="post">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    @php
                        $customers_sel = App\Models\Customer::find(explode(',', $template->customer_ids))->pluck('id', 'name');
                    @endphp
                    <div class="form-group row mb-3">
                        {!! Form::label('customer_ids', trans('templates.customers'), ['class' => 'col-md-3 col-form-label']) !!}
                        <div class="col-md-9">
                            {!! Form::select('customer_ids[]', $customers, $customers_sel, ['id' => 'customer_ids', 'required' => 'true', 'multiple'=>'multiple', 'class' => 'form-control js-example-basic-multiple']) !!}
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 text-right">
                            {!! Form::submit(trans('templates.update table'), ['class' => 'btn btn-primary waves-effect']) !!}
                        </div>
                    </div>
                </div>
            </div>
